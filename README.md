...
I would explain that semantic HTML is HTML that is intended to add structure and meaning to your code.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display:inline does exactly what it sounds like, it will display elements in line within a block.

display:block will put an element into a block which spans the entire width of the page.
...
Git is valuable to a team of developers because it allows each individul to work on their own code branch to make changes safely without affecting the main repository incase of breaks. It also allows for a team of multiple people to contribute to the development in a safe way.
